...
public class PhotoPreview extends ViewGroup implements SurfaceHolder.Callback {
	private final String DEBUG_TAG = "PE PhotoPreview";
...
//	}
	...
	public void setCamera(Camera camera) {
		...
		if (mCamera != null) {
			...
			for (Size size : mSupportedPreviewSizes) {
				Log.d(DEBUG_TAG, "supported preview size: " + size.width + ","
						+ size.height);
			}
			requestLayout();
		}
	...
	public void switchCamera(Camera camera) {
		...
		try {
			...
			Log.e(DEBUG_TAG, "IOException caused by setPreviewDisplay()", exception);
		}
